...
public class SdkPlugin extends AbstractUIPlugin {
	...
	/** The manifest of available AWS SDK for Java versions */
	private static Properties sdkVersions;
	...
	public void start(BundleContext context) throws Exception {
		...
		new Job("Initializing SDK") {
            @Override
            protected IStatus run(IProgressMonitor monitor) {
                SdkManager.getInstance().initializeSDKInstalls();
