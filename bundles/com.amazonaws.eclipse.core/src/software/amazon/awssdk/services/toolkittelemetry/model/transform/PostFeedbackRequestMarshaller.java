...
/**
 * PostFeedbackRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class PostFeedbackRequestMarshaller {
    ...
    private static final PostFeedbackRequestMarshaller instance = new PostFeedbackRequestMarshaller();

    public static PostFeedbackRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PostFeedbackRequest postFeedbackRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(postFeedbackRequest.getAWSProduct(), AWSPRODUCT_BINDING);
            protocolMarshaller.marshall(postFeedbackRequest.getAWSProductVersion(), AWSPRODUCTVERSION_BINDING);
            protocolMarshaller.marshall(postFeedbackRequest.getOS(), OS_BINDING);
            protocolMarshaller.marshall(postFeedbackRequest.getOSVersion(), OSVERSION_BINDING);
            protocolMarshaller.marshall(postFeedbackRequest.getParentProduct(), PARENTPRODUCT_BINDING);
            protocolMarshaller.marshall(postFeedbackRequest.getParentProductVersion(), PARENTPRODUCTVERSION_BINDING);
            protocolMarshaller.marshall(postFeedbackRequest.getMetadata(), METADATA_BINDING);
            protocolMarshaller.marshall(postFeedbackRequest.getSentiment(), SENTIMENT_BINDING);
            protocolMarshaller.marshall(postFeedbackRequest.getComment(), COMMENT_BINDING);
        } catch (Exception e) {
