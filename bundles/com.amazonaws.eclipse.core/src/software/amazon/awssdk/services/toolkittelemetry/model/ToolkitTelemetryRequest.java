...
public abstract class ToolkitTelemetryRequest extends AwsRequest {
    protected ToolkitTelemetryRequest(Builder builder) {
        super(builder);
    }
    ...
    protected abstract static class BuilderImpl extends AwsRequest.BuilderImpl implements Builder {
        ...
        protected BuilderImpl(ToolkitTelemetryRequest request) {
            super(request);
        }
    }
}
