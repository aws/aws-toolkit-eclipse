...
public abstract class SelectionTable extends Composite {
	 ...
	 */
	protected String ec2EndpointOverride;
	...
	/**
	 * Sets the optional EC2 endpoint override for this selection table. Setting
	 * this value will cause the EC2 client returned by the getClient method to
	 * *always* use this EC2 endpoint, and will completely ignore the EC2 region
	 * selected in the system preferences.
	 *
	 * @param endpoint
	 *            The EC2 endpoint to use instead of defaulting to the currently
	 *            selected EC2 region in the system preferences.
	 */
	public void setEc2EndpointOverride(String endpoint) {
