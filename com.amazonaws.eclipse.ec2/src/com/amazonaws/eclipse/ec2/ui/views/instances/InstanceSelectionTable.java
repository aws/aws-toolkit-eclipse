...
public class InstanceSelectionTable extends SelectionTable implements IRefreshable, IMenu {
	...
	protected void fillContextMenu(IMenuManager manager) {
		...
		openShellAction.setEnabled(isRunningInstanceSelected && getSelectedInstance().getKeyName() != null);

		copyPublicDnsNameAction.setEnabled(exactlyOneInstanceSelected);
		createAmiAction.setEnabled(exactlyOneInstanceSelected && getSelectedInstance().getKeyName() != null);
