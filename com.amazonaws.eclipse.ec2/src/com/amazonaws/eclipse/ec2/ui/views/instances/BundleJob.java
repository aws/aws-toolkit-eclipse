...
class BundleJob extends Job {
	...
	private String registerBundle(IProgressMonitor monitor) {
		...
		AmazonEC2 ec2 = new Ec2ClientFactory().getAwsClient();
	...
	private void uploadBundle(IProgressMonitor monitor) throws IOException,
		...
		/*
		 * TODO: we probably need some sort of abstraction around regions so
		 * that we aren't just pulling it out of the preferences all the time.
		 */
